...
Future<void> setupServiceLocator() async {
  ...
  if (!getIt.isRegistered<HasScheduleConflictUsecase>()) {
    getIt.registerLazySingleton<HasScheduleConflictUsecase>(
      () => HasScheduleConflictUsecase(getIt<AppointmentRepository>()),
    );
  }
  ...
  if (!getIt.isRegistered<BookingBloc>()) {
    getIt.registerFactory<BookingBloc>(
      () => BookingBloc(
        ...
        hasScheduleConflict: getIt<HasScheduleConflictUsecase>(),
        getPatientActiveAppointments:
            getIt<GetPatientActiveAppointmentsUsecase>(),
      ),
    );
  }
  ...
  if (!getIt.isRegistered<GetNotificationTemplatesByDepartmentUseCase>()) {
    getIt.registerLazySingleton<GetNotificationTemplatesByDepartmentUseCase>(
      () => GetNotificationTemplatesByDepartmentUseCase(
    ...
    getIt.registerFactory<NotificationBloc>(
      () => NotificationBloc(
        ...
        sendAppointmentConfirmation:
            getIt<SendAppointmentConfirmationUseCase>(),
        sendAppointmentCancelled: getIt<SendAppointmentCancelledUseCase>(),
        scheduleAppointmentReminders:
            getIt<ScheduleAppointmentRemindersUseCase>(),
        sendPreparationInstructions:
            getIt<SendPreparationInstructionsUseCase>(),
        ...
        scheduleMedicationReminders:
            getIt<ScheduleMedicationRemindersUseCase>(),
